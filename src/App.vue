<template>
    <div id="app">
        ...
        <section id="welcome-section" class="flex flex-col items-center justify-center min-h-screen py-12">

            <img class="h-48 sm:h-64 w-48 sm:w-64 mb-8 rounded-full" src="@/assets/images/me.png" alt="profile-pic">
            <h1 class="font-medium text-5xl text-center">Hey, I'm James.</h1>
            <span class="text-3xl">a software developer</span>

            <div class="flex flex-wrap justify-center mt-8 w-full">
                <Bubble title="instagram" href="https://www.instagram.com/getsomemoore94/" icon-type="fab" icon="instagram" color="text-pink-500"></Bubble>
                <Bubble title="github" href="https://github.com/James-N-M" icon-type="fab" icon="github" color="text-white"></Bubble>
                <Bubble title="linked-in" href="https://www.linkedin.com/in/james-moore-4797b6128/" icon-type="fab" icon="linkedin" color="text-blue-500"></Bubble>
                <Bubble title="codepen" href="https://codepen.io/James_M0025/" icon-type="fab" icon="codepen" color="text-purple-500"></Bubble>
                <Bubble title="medium" href="https://medium.com/@jomesmoore" icon-type="fab" icon="medium" color="text-green-500"></Bubble>
                <Bubble title="exercism" href="https://exercism.io/profiles/James-N-M" icon-type="fas" icon="code" color="text-yellow-500"></Bubble>
            </div>
        </section>

        <section id="About" class="py-16">
            <div class="flex justify-center flex-wrap">
                <div class="mx-2 sm:w-1/5">
                    <img src="@/assets/images/about-me.png" alt="picture">
                </div>
        ...
        <section>
            ...
            <div class="flex justify-center text-center">
                <ul class="list-reset pb-10 text-2xl underline">
                    <a href="https://drive.google.com/open?id=1zCOi5LLu1sByoRqzK3MVQz_4CT0guNjF">
                        <li>Lighting Talk Windsor Hackforge: Tailwind CSS</li>
                    </a>
                </ul>
            </div>
        </section>

        <section id="Contact" class="flex flex-col items-center justify-center py-16">
            <h1>Lets work together...</h1>
            <span class="text-black">I look forward to hearing from you !</span>
            <Bubble title="email me" href="mailto:jamesm0025@gmail.com" icon-type="far" icon="envelope" color="text-white"></Bubble>
        </section>
